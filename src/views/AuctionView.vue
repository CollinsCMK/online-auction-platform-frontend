<template>
  <TopLayout>
    <CmkPagination :items="auctions" :itemsPerPage="3" myClass="flex items-center justify-center gap-4">
      ...
      <div class="flex items-center justify-between mb-4">
        ...
        <p class="rounded-full bg-green-600/[.2] text-green-600 px-3 py-1 font-semibold">{{ item.status }}</p>
      </div>
...
const auctions = ref([
  ...
  },
  {
    ...
    status: "Active",
    description: "Fender Stratocaster personally signed by Eric Clapton with certificate of authenticity.",
